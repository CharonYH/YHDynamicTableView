...
@implementation YHDynamicTableViewCellC
...
- (void)setFrame:(CGRect)frame {
    frame.origin.x += kYHDynamicTableViewCellMarginC;
    frame.size.width -= kYHDynamicTableViewCellMarginC * 2;
    [super setFrame:frame];
}

- (void (^)(YHDynamicTableViewCellCConfigurator _Nullable))configurator {
    return ^(YHDynamicTableViewCellCConfigurator _Nullable configurator) {
...
- (YHDynamicCollectionView *)collectionView {
    if (!_collectionView) {
        ...
        layout.minimumInteritemSpacing = (YHScreenWidth - 2 * kYHDynamicTableViewCellMarginC - kYHDynamicCollectionColumn * 54 - kYHDynamicComponentMargin * 2) / (kYHDynamicCollectionColumn - 1);
